...
final previewRewardProvider = Provider<PlacementReward>((ref){
 ...
 if (placement.selected==null || tile==null) return const PlacementReward(connectedSides: [], bonusTiles: 0);
...
void confirmPlacement(WidgetRef ref){
 ...
 ref.read(lastPlacementProvider.notifier).state=LastPlacement(p.selected!, tile);
